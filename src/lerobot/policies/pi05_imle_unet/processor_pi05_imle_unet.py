...
from lerobot.policies.pi05_imle_unet.modeling_pi05_imle_unet import pad_vector
...
@ProcessorStepRegistry.register(name="pi05_imle_unet_prepare_state_tokenizer_processor_step")
@dataclass
...
def make_pi05_imle_unet_pre_post_processors(
