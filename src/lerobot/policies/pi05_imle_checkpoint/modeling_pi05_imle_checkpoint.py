...
class PI05IMLECheckpointPytorch(nn.Module):  # modified from openpi `PI0Pytorch`
    """Core PI05 + IMLE PyTorch model."""

    def __init__(self, config: PI05IMLECheckpointConfig):
        super().__init__()
        self.config = config
...
class PI05IMLECheckpointPolicy(PreTrainedPolicy):
    """PI05 Policy for LeRobot."""

    config_class = PI05IMLECheckpointConfig
    name = "pi05_imle_checkpoint"
    ...
    def __init__(
        ...
        self.model = PI05IMLECheckpointPytorch(config)
    ...
    def from_pi05(
        ...
        **kwargs,
        ...
        """
            ...
            We load both the PaLiGemma2B parameters and the action expert parameters.
        """
        print(
            """
                This function creates a model where we load both the PaLIGemma2B
                parameters and the Gemma Expert model parameters.
                This should create a skeleton model for finetuning the Gemma
                Expert only.
            """ 
        )
